...
public class PageCaijing extends BaseIndexPage {
    ...
    public PageCaijing(Context context) {
    ...
    * */
    public void dataFromNet() {
        ...
        HttpUtil.sendHttpRequest(Constant.urlCaijing, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Activity activity = (Activity) PageCaijing.this.context;
                activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ToastUtil.show(PageCaijing.this.context, "可能没网了");
                    }
                });
            }
