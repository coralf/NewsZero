...
public class PageJunshi extends BaseIndexPage {
    ...
    public PageJunshi(Context context) {
    ...
    * */
    public void dataFromNet() {
        ...
        HttpUtil.sendHttpRequest(Constant.urlJunshi, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Activity activity = (Activity) PageJunshi.this.context;
                activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ToastUtil.show(PageJunshi.this.context, "可能没网了");
                    }
                });
            }
