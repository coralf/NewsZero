...
public class PageGuoji extends BaseIndexPage {
    ...
    public PageGuoji(Context context) {
    ...
    * */
    public void dataFromNet() {
        ...
        HttpUtil.sendHttpRequest(Constant.urlGuoji, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Activity activity = (Activity) PageGuoji.this.context;
                activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ToastUtil.show(PageGuoji.this.context, "可能没网了");
                    }
                });
            }
